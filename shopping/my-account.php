...
header('location:login.php');
	...
	if(isset($_POST['update']))
	{
		...
		$pres=$_POST['pres'];
		$query=mysqli_query($con,"update users set name='$name',contactno='$contactno',pres='$pres'  where id='".$_SESSION['id']."'");
		if($query)
		{
...
<div class="form-group">
			 ...
			 <input type="email" class="form-control unicase-form-control text-input" id="exampleInputEmail1" value="<?php echo $row['email'];?>" readonly>
					  ...
					  <div class="form-group">
					        <label class="info-title" for="pres">Prescription</label> <br>
                            <textarea name="pres"  placeholder="Enter Product Description" rows="6" class="span8 tip" ><?php echo $row['pres'];?> </textarea>
					  </div>
